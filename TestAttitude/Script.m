...
% filePath = 'Datasets/mylogs';
% startTime =1;
% stopTime = 1.2;

filePath = 'straightLine';
startTime = 6;
stopTime = 26;
...
samplePeriod = 1/256;%这个物理量的意义是“连续”采样的间隔时间
xIMUdata = xIMUdataClass(filePath, 'InertialMagneticSampleRate', 1/samplePeriod);%涉及类定义



%下面这条是把原始数据从0开始按照采样周期排下来得到的
